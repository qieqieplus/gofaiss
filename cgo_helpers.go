...
func (x *FaissClusteringParameters) Deref() {
	...
	x.DecodeBlockSize = (uint)(x.ref9c9731c3.decode_block_size)
}
...
func (x *FaissIndexIVFStats) Deref() {
	...
	x.NheapUpdates = (uint)(x.refda0d0668.nheap_updates)
...
func (x *FaissBuffer) PassRef() (*C.FaissBuffer, *cgoAllocMap) {
	...
	refe3f43253.ids, cids_allocs = copyPIdxBytes((*sliceHeader)(unsafe.Pointer(&x.Ids)))
	allocse3f43253.Borrow(cids_allocs)

	var cdis_allocs *cgoAllocMap
	refe3f43253.dis, cdis_allocs = copyPFloatBytes((*sliceHeader)(unsafe.Pointer(&x.Dis)))
...
// Ref returns a reference to C object as it is.
func (x *FaissRangeQueryResult) Ref() *C.FaissRangeQueryResult {
	if x == nil {
		return nil
	}
	return (*C.FaissRangeQueryResult)(unsafe.Pointer(x))
}

// Free cleanups the referenced memory using C free.
func (x *FaissRangeQueryResult) Free() {
	if x != nil {
		C.free(unsafe.Pointer(x))
	}
}

// NewFaissRangeQueryResultRef converts the C object reference into a raw struct reference without wrapping.
func NewFaissRangeQueryResultRef(ref unsafe.Pointer) *FaissRangeQueryResult {
	return (*FaissRangeQueryResult)(ref)
}

// NewFaissRangeQueryResult allocates a new C object of this type and converts the reference into
// a raw struct reference without wrapping.
func NewFaissRangeQueryResult() *FaissRangeQueryResult {
	return (*FaissRangeQueryResult)(allocFaissRangeQueryResultMemory(1))
}

// allocFaissRangeQueryResultMemory allocates memory for type C.FaissRangeQueryResult in C.
// The caller is responsible for freeing the this memory via C.free.
func allocFaissRangeQueryResultMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfFaissRangeQueryResultValue))
	if mem == nil {
		panic(fmt.Sprintln("memory alloc error: ", err))
	}
	return mem
...
const sizeOfFaissRangeQueryResultValue = unsafe.Sizeof([1]C.FaissRangeQueryResult{})

// PassRef returns a reference to C object as it is or allocates a new C object of this type.
func (x *FaissRangeQueryResult) PassRef() *C.FaissRangeQueryResult {
	if x == nil {
		x = (*FaissRangeQueryResult)(allocFaissRangeQueryResultMemory(1))
	}
	return (*C.FaissRangeQueryResult)(unsafe.Pointer(x))
}

// Ref returns a reference to C object as it is.
func (x *FaissDistanceComputer) Ref() *C.FaissDistanceComputer {
	if x == nil {
		return nil
	}
	return (*C.FaissDistanceComputer)(unsafe.Pointer(x))
}

// Free cleanups the referenced memory using C free.
func (x *FaissDistanceComputer) Free() {
	if x != nil {
		C.free(unsafe.Pointer(x))
	}
}

// NewFaissDistanceComputerRef converts the C object reference into a raw struct reference without wrapping.
func NewFaissDistanceComputerRef(ref unsafe.Pointer) *FaissDistanceComputer {
	return (*FaissDistanceComputer)(ref)
}

// NewFaissDistanceComputer allocates a new C object of this type and converts the reference into
// a raw struct reference without wrapping.
func NewFaissDistanceComputer() *FaissDistanceComputer {
	return (*FaissDistanceComputer)(allocFaissDistanceComputerMemory(1))
}

// allocFaissDistanceComputerMemory allocates memory for type C.FaissDistanceComputer in C.
// The caller is responsible for freeing the this memory via C.free.
func allocFaissDistanceComputerMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfFaissDistanceComputerValue))
	if mem == nil {
		panic(fmt.Sprintln("memory alloc error: ", err))
	}
	return mem
...
const sizeOfFaissDistanceComputerValue = unsafe.Sizeof([1]C.FaissDistanceComputer{})

// PassRef returns a reference to C object as it is or allocates a new C object of this type.
func (x *FaissDistanceComputer) PassRef() *C.FaissDistanceComputer {
	if x == nil {
		x = (*FaissDistanceComputer)(allocFaissDistanceComputerMemory(1))
	}
	return (*C.FaissDistanceComputer)(unsafe.Pointer(x))
}
